// Generate all tool pages with CATEGORY-SPECIFIC templates
const fs = require('fs');
...
const translations = {
    ...
    fr: {
        ...
        dragDrop: 'Glisser-déposer ici', orBrowse: 'ou Parcourir',
        outputFormat: 'Format de sortie', quality: 'Qualité', convert: 'Convertir',
        download: 'Télécharger', calculate: 'Calculer', generate: 'Générer'
    },
    es: {
        ...
        dragDrop: 'Arrastra aquí', orBrowse: 'o Explorar',
        convert: 'Convertir', download: 'Descargar',
        calculate: 'Calcular', generate: 'Generar'
    },
    de: {
        ...
        dragDrop: 'Hier ablegen', orBrowse: 'oder Durchsuchen',
        convert: 'Konvertieren', download: 'Herunterladen',
        calculate: 'Berechnen', generate: 'Generieren'
    }
};
    ...
    if (isBMI) {
        ...
        inputs = `
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 md:col-span-2">
                        <label class="block text-sm font-medium mb-2">${tLang('birthDate', lang)}</label>
...
function generateTextInterface(tool, lang, t) {
    return `
                ...
                <div class="mb-6">
                    ...
                    <textarea id="input" rows="6" class="w-full p-4 rounded-lg border dark:border-gray-600 dark:bg-gray-700 font-mono text-sm" placeholder="${tLang('enterTextHere', lang)}"></textarea>
                </div>
...
function tLang(key, lang) {
    const extra = {
        birthDate: { ar: 'تاريخ الميلاد', en: 'Birth Date', fr: 'Date de naissance', es: 'Fecha de nacimiento', de: 'Geburtsdatum' },
        enterTextHere: { ar: 'أدخل النص هنا...', en: 'Enter text here...', fr: 'Entrez le texte ici...', es: 'Ingrese texto aquí...', de: 'Text hier eingeben...' }
    };
    return (extra[key] && extra[key][lang]) || key;
}
        ...
        <div class="max-w-5xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="font-semibold mb-2">${t.chooseFile || t.inputData}</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="font-semibold mb-2">${t.waitProcessing}</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="font-semibold mb-2">${t.getResult}</h3>
    ...
    <section class="py-12">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <div class="text-center p-6"><div class="text-3xl mb-3">✨</div><h3 class="font-semibold mb-2">${t.quality}</h3></div>
            </div>
        </div>
    </section>
...
console.log(`✅ Generated ${count} tool pages with category-specific templates!`);
console.log('Templates used:');
console.log('- File upload (Images, PDF)');
console.log('- Calculator (Math, Time)');
console.log('- Generator (Security, Data)');
console.log('- Text editor (Text, SEO)');
console.log('- Code editor (Developers)');
console.log('- Converter (Units)');
